/*
  ...
  - You are about to drop the column `payload` on the `Flight` table. All the data in the column will be lost.
  ...
  - Added the required column `encodedPayload` to the `Flight` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Flight" ("createdAt", "encoding", "id", "updatedAt") SELECT "createdAt", "encoding", "id", "updatedAt" FROM "Flight";
DROP TABLE "Flight";
