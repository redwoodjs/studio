/*
  ...
  - A unique constraint covering the columns `[mailTemplateId,name]` on the table `MailTemplateComponent` will be added. If there are existing duplicate values, this will fail.

*/
-- DropIndex
DROP INDEX "MailTemplateComponent_name_key";
