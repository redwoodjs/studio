...
CREATE TABLE "new_MailTemplateComponent" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "name" TEXT NOT NULL,
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "MailTemplateComponent_mailTemplateId_fkey" FOREIGN KEY ("mailTemplateId") REFERENCES "MailTemplate" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_MailTemplateComponent" ("createdAt", "id", "mailTemplateId", "name", "propsTemplate", "updatedAt") SELECT "createdAt", "id", "mailTemplateId", "name", "propsTemplate", "updatedAt" FROM "MailTemplateComponent";
DROP TABLE "MailTemplateComponent";
ALTER TABLE "new_MailTemplateComponent" RENAME TO "MailTemplateComponent";
CREATE INDEX "MailTemplateComponent_mailTemplateId_idx" ON "MailTemplateComponent"("mailTemplateId");
CREATE UNIQUE INDEX "MailTemplateComponent_mailTemplateId_name_key" ON "MailTemplateComponent"("mailTemplateId", "name");
